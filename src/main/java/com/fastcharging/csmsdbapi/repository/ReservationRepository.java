...
import com.fastcharging.csmsdbapi.model.Reservation;
...
public interface ReservationRepository extends JpaRepository<Reservation, Long>{
	...
	@Query(value = "SELECT \r\n" + 
			...
			"  rsvp.status, \r\n" + 
			"  cn.connector_id as connectorId, \r\n" + 
			"  mcs.name AS NameCS, \r\n" + 
			"  mcs.location, \r\n" + 
			"  mcs.longitude, \r\n" + 
			"  mcs.latitude, \r\n" + 
			...
			"FROM \r\n" + 
			"  reservation rsvp \r\n" + 
			"  INNER JOIN connector cn ON rsvp.connector_pk = cn.connector_pk \r\n" + 
			...
			"  AND TIMESTAMPDIFF(\r\n" + 
			"    SECOND, NOW(), rsvp.expiry_datetime\r\n" + 
			"  )>= 0 \r\n" + 
			"  AND rsvp.id_tag = ? \r\n" + 
			"ORDER BY \r\n" + 
